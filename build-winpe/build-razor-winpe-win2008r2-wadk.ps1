...
# Known issue: This results in an execution error:
# setup.exe - Entry Point Not Found
#   The procedure entry point ??0WString2@@QEAA@XZ could
#   not be located in the dynamic link library
#   X:\windows\system32\wbem\fastprox.dll.
...
$adk = "C:/Program Files (x86)/Windows Kits/8.0/Assessment and Deployment Kit/Windows Preinstallation Environment/amd64"
write-host "ADK is looking in $adk"
...
$wim = join-path $adk "C:/Program Files (x86)/Windows Kits/8.0/Assessment and Deployment Kit/Windows Preinstallation Environment/amd64/en-us/winpe.wim"

# Root for the CAB files for optional features.
$packages = join-path $adk "Tools/PETools/amd64/WinPE_FPs"
...
$dism = join-path $adk "Deployment Tools/amd64/DISM/dism.exe"
